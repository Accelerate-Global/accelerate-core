...
- Does the architecture align with the repository-level and folder-level `AGENTS.md` guidance that applies to the affected code?
- If multiple `AGENTS.md` files apply, is the plan following the most specific relevant guidance?
...
- Does the architecture leave room to actually use any required skills carried from the workflow seed or applicable `AGENTS.md` guidance?
...
1. **Gather Context**
  ...
  - Applicable `AGENTS.md` guidance for the implementation areas affected by the Tech Plan
  - Any required skills established by the workflow seed or applicable `AGENTS.md` guidance
...
3. **Identify Critical Decisions**
  ...
  - Interact with architectural constraints or preferred patterns established by applicable `AGENTS.md` files
